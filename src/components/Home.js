    ...
    return (
      <div className={this.props.show ? "homerdown" : "homer"}>
        <div className="homestuff">
            ...
            <div onClick={() => this.props.changeView("portfolio")} className="homebutton">PORTFOLIO</div>
            <div onClick={() => this.props.changeView("skills")} className="homebutton">SKILLS AND TECHS</div>
        </div>
      </div>
    );
  }
